            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th>
                    <x-column-header dataRoute="admin.events" column-name="event_name" :sort-column="$sortColumn" :sortDirection="$sortDirection">Event</x-column-header>
                  </th>
                  <th>
              ...
              <tbody>
                @foreach ($visitors as $visitor)
                  <tr>
                    <td>{{ $visitor->id }}</td>
                    <td width="250px">{{ Str::words($visitor->event_name, 9, '...') }}</td>
                    <td>
